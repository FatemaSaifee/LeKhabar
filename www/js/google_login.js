angular.module('GoogleLoginService', ['ionic'])
.factory('timeStorage', function () {
        var timeStorage = {};
...
.factory('googleLogin', ['$http', '$q', '$interval', '$log', 'timeStorage', 
    function ($http, $q, $interval, $log, timeStorage) {
        var service = {};
        service.access_token = false;
        service.redirect_url = 'http://localhost:8100/news_card';
        service.client_id = '1080627668025-tfnrstdhl7lukditulskiruk61h7b463.apps.googleusercontent.com';
        service.secret = '7qLMLJHS8i2WKpJ9_Vg-y3kH';
        ...
        service.gulp = function (url, name) {
            url = url.susbtring(url.indexOf('?') + 1, url.length);
